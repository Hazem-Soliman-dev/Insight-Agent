    ...
    <div className="min-h-screen bg-background relative overflow-hidden font-sans pb-0">
      ...
      <main className="container mx-auto px-4 py-8 sm:py-12 relative z-10 max-w-4xl">
        <div className="space-y-6 sm:space-y-8">
          ...
          <Card className="border border-white/5 bg-zinc-900/15 backdrop-blur-md rounded-2xl shadow-lg relative overflow-hidden group">
            ...
            <CardHeader className="p-5 pb-2 relative">
              <div>
                ...
                <CardDescription className="text-xs text-zinc-500 font-semibold">Available credits for AI querying and analysis</CardDescription>
              </div>
            </CardHeader>
            <CardContent className="p-5 pt-2 relative flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
              <div>
                <div className="flex items-baseline gap-2">
                  ...
                  <span className="text-sm sm:text-base text-indigo-400 font-extrabold uppercase tracking-wider">credits</span>
                </div>
                <p className="text-xs text-zinc-400 mt-2.5 leading-relaxed max-w-md font-semibold">
                  1 credit is spent per successful AI analytical query. Zero monthly reset limits.
                </p>
              </div>
              <Button asChild className="w-full sm:w-auto gap-2 text-xs font-bold bg-indigo-650 hover:bg-indigo-750 text-white py-5 px-6 rounded-xl shadow-lg shadow-indigo-650/20 hover:-translate-y-0.5 transition-all duration-200 border border-indigo-500/25">
          ...
          <div className="flex md:grid md:grid-cols-3 gap-5 overflow-x-auto md:overflow-x-visible pb-4 md:pb-0 snap-x snap-mandatory -mx-4 px-4 md:mx-0 md:px-0 scrollbar-none">
            {/* Projects Quota */}
            <Card className="min-w-[280px] sm:min-w-[320px] md:min-w-0 flex-1 shrink-0 md:shrink border border-white/5 bg-zinc-900/15 backdrop-blur-md hover:border-indigo-500/30 hover:bg-zinc-900/35 transition-all duration-300 relative overflow-hidden group rounded-2xl shadow-md flex flex-col justify-between snap-center">
              <div className="absolute top-0 right-0 w-20 h-20 bg-indigo-500/5 rounded-full blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none" />
              <CardHeader className="p-5 pb-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-indigo-500/10 via-purple-500/10 to-pink-500/10 border border-indigo-500/20 flex items-center justify-center text-indigo-400 group-hover:scale-105 transition-transform duration-300 shrink-0 shadow-sm">
                      <Database className="h-5 w-5 text-indigo-400" />
                    </div>
                    <CardTitle className="text-sm sm:text-base font-extrabold text-zinc-200">Projects</CardTitle>
                  </div>
                  <span className={`px-2.5 py-0.5 rounded-full text-[10px] font-extrabold border uppercase tracking-wider ${projectsPercentage >= 80 ? 'bg-rose-500/10 border-rose-500/25 text-rose-400' : 'bg-indigo-500/10 border-indigo-500/25 text-indigo-400'}`}>
                    {usage.projects.used} / {usage.projects.limit === -1 ? '∞' : usage.projects.limit}
                  </span>
                </div>
                <CardDescription className="text-xs text-zinc-500 pt-1.5 font-semibold">Active analytics databases/projects</CardDescription>
              </CardHeader>
              <CardContent className="px-5 pb-5 pt-1">
                {usage.projects.limit !== -1 ? (
                  <div className="space-y-3">
                    <Progress value={projectsPercentage} className="h-1.5 bg-zinc-950/80" />
            ...
            {/* AI Queries Count */}
            <Card className="min-w-[280px] sm:min-w-[320px] md:min-w-0 flex-1 shrink-0 md:shrink border border-white/5 bg-zinc-900/15 backdrop-blur-md hover:border-indigo-550/30 hover:bg-zinc-900/35 transition-all duration-300 relative overflow-hidden group rounded-2xl shadow-md flex flex-col justify-between snap-center">
              ...
              <CardHeader className="p-5 pb-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="h-10 w-10 rounded-xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center text-emerald-400 group-hover:scale-105 transition-transform duration-300 shrink-0 shadow-sm">
                      <Zap className="h-5 w-5 text-emerald-400" />
                    </div>
                    <CardTitle className="text-sm sm:text-base font-extrabold text-zinc-200">Queries Made</CardTitle>
                  </div>
                  <span className="px-2.5 py-0.5 rounded-full text-[10px] font-extrabold bg-emerald-500/10 border border-emerald-500/25 text-emerald-400 uppercase tracking-wider">
                    {usage.queries.totalExecuted}
                  </span>
                </div>
                <CardDescription className="text-xs text-zinc-500 pt-1.5 font-semibold">Total AI-driven insights generated</CardDescription>
              </CardHeader>
              <CardContent className="px-5 pb-5 pt-1">
                <div className="flex items-baseline gap-1.5">
                  <span className="text-2xl sm:text-3xl font-extrabold text-zinc-200">{usage.queries.totalExecuted}</span>
                  <span className="text-[10px] text-zinc-500 font-extrabold uppercase tracking-wider">operations</span>
                </div>
            ...
            {/* File Upload Quotas */}
            <Card className="min-w-[280px] sm:min-w-[320px] md:min-w-0 flex-1 shrink-0 md:shrink border border-white/5 bg-zinc-900/15 backdrop-blur-md hover:border-indigo-555/30 hover:bg-zinc-900/35 transition-all duration-300 relative overflow-hidden group rounded-2xl shadow-md flex flex-col justify-between snap-center">
              ...
              <CardHeader className="p-5 pb-3">
                <div className="flex items-center gap-3">
                  <div className="h-10 w-10 rounded-xl bg-purple-500/10 border border-purple-500/20 flex items-center justify-center text-purple-400 group-hover:scale-105 transition-transform duration-300 shrink-0 shadow-sm">
              ...
              <CardContent className="px-5 pb-5 pt-1">
                <div className="flex items-baseline gap-1">
                  ...
                  <span className="text-xs font-extrabold text-zinc-500">MB</span>
                </div>
                <p className="text-[11px] text-zinc-400 mt-2 leading-relaxed font-semibold">
